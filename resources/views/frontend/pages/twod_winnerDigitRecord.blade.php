...
<div class="mt-5 pt-4" style="padding-bottom: 100px;">
    <small class="text-center fs-5 fw-bold mt-3 d-block mb-3">နောက်ဆုံး ထွက်ဂဏန်းများ</small>
    <div class="d-flex justify-content-between">
        <button class="btn btn-purple w-100 py-3 active" id="morning">
            <i class="fas fa-clock fs-3 d-block mb-2"></i>
            <small class="fs-5">မနက်ပိုင်း</small>
        </button>
        <button class="btn btn-purple w-100 py-3" id="evening">
            <i class="fas fa-clock fs-3 d-block mb-2"></i>
            <small class="fs-5">ညနေပိုင်း</small>
        </button>
    </div>
    <div class="morning my-3 text-center">
        <div class="border-purple rounded-4 p-3 mb-3">
            <div class="row">
                <div class="col-3">
